...
class StructuredClaudeClient extends events_1.EventEmitter {
    rawClient;
    turns = [];
    pendingTurns = [];
    ...
    static async init(config) {
        const rawClient = new client_js_1.ClaudeClient(config);
...
exports.StructuredClaudeClient = StructuredClaudeClient;
